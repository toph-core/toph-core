...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "strBackToScreen": MessageLookupByLibrary.simpleMessage("Orgaga qaytish"),
    ...
    "strDoYouWantSendOrdersToKitchken": MessageLookupByLibrary.simpleMessage(
    ...
    "strEnterBrandID": MessageLookupByLibrary.simpleMessage(
      "Brand id ni yozing",
    ),
    ...
    "strFailureMessage_server": MessageLookupByLibrary.simpleMessage(
      "A server error occurred",
    ),
    "strFailureMessage_timeout": MessageLookupByLibrary.simpleMessage(
      "Connection timed out, the network may be slow or busy",
    ),
    "strFailureMessage_unauthenticated": MessageLookupByLibrary.simpleMessage(
    ...
    "strInvalidNumber": MessageLookupByLibrary.simpleMessage("Noto‘g‘ri raqam"),
    "strLogin": MessageLookupByLibrary.simpleMessage("Kirish"),
    "strLogout": MessageLookupByLibrary.simpleMessage("Chiqish"),
    "strNameTooShort": MessageLookupByLibrary.simpleMessage(
      "Name is too short",
    ),
    "strNo": MessageLookupByLibrary.simpleMessage("Yo\'q"),
    "strNoDataFound": MessageLookupByLibrary.simpleMessage(
      "Ma\'lumot topilmadi",
    ),
    "strNoInternetConnection": MessageLookupByLibrary.simpleMessage(
    ...
    "strPasswordsNotSame": MessageLookupByLibrary.simpleMessage(
      "Passwords are not same",
    ),
    "strPhoneOrPasswordWrong": MessageLookupByLibrary.simpleMessage(
      "Telefon raqami yoki parol noto‘g‘ri",
    ),
    "strProductNotFound": MessageLookupByLibrary.simpleMessage(
    ...
    "strRefreshCompleted": MessageLookupByLibrary.simpleMessage(
      "Yangilash tugadi",
    ),
    "strRefreshFailed": MessageLookupByLibrary.simpleMessage(
      "Yangilash amalga oshmadi",
    ),
    "strRefreshing": MessageLookupByLibrary.simpleMessage(
      "Ma’lumot yangilanmoqda...",
    ),
    "strReleaseToRefresh": MessageLookupByLibrary.simpleMessage(
      "Qo‘yib yuboring — yangilanadi",
    ),
    "strRetry": MessageLookupByLibrary.simpleMessage("Qayta urinib ko‘rish"),
    ...
    "strSelectGuestsCount": MessageLookupByLibrary.simpleMessage(
      "Mehmonlar sonini belgilang",
    ),
    "strTable": MessageLookupByLibrary.simpleMessage("Stol"),
    "strUnacceptableDate": MessageLookupByLibrary.simpleMessage(
      "Unacceptable date",
    ),
