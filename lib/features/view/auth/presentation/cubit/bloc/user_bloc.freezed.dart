...
abstract class $UserStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({Status status, UserModel? userMOdel, Failure? failure});
...
class _$UserStateImpl implements _UserState {
  ...
  @override
  int get hashCode => Object.hash(runtimeType, status, userMOdel, failure);
...
abstract class _UserState implements UserState {
  const factory _UserState(
      {final Status status,
      final UserModel? userMOdel,
      final Failure? failure}) = _$UserStateImpl;
