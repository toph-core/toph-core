      ...
      body: Row(
        ...
        children: [
          Expanded(
                  ...
                  child: DecoratedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Text("Gamburger", style: context.textStyles.bodyMd),
                            const Spacer(),
                            Text(
                              "60 000 so'm",
                        ...
                        Row(
                          children: [
                            Text("2x Lavash", style: context.textStyles.bodyMd),
                            const Spacer(),
                            Text(
                              "160 000 so'm",
                              style: context.textStyles.bold16.copyWith(
                        ...
                        Row(
                          children: [
                            Text("Chegirma", style: context.textStyles.bodyMd),
                            const Spacer(),
                            Text(
                              "8 000 so'm",
                              style: context.textStyles.bold16.copyWith(
           ...
           Expanded(flex: 2, child: PaymentRightSideBar()),
        ],
      ).paddingAll(32),
    );
  }
